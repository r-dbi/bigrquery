...
[`bq_project_query()`](https://bigrquery.r-dbi.org/reference/bq_query.md)/[`bq_dataset_query()`](https://bigrquery.r-dbi.org/reference/bq_query.md),
and
[`bq_table_download()`](https://bigrquery.r-dbi.org/reference/bq_table_download.md).
...
- ...:
  ...
  [`bq_project_query()`](https://bigrquery.r-dbi.org/reference/bq_query.md)/[`bq_project_query()`](https://bigrquery.r-dbi.org/reference/bq_query.md)
