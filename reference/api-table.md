...
- x:
  ...
  A [bq_table](https://bigrquery.r-dbi.org/reference/bq_refs.md), or an
  object coercible to a `bq_table`.
...
- dest:
  ...
  [bq_table](https://bigrquery.r-dbi.org/reference/bq_refs.md)s.
