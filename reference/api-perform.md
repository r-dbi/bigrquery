...
- x:
  ...
  A [bq_table](https://bigrquery.r-dbi.org/reference/bq_refs.md)
...
- fields:
  ...
  A [bq_fields](https://bigrquery.r-dbi.org/reference/bq_field.md)
...
- parameters:
  ...
  call
  [`bq_param_scalar()`](https://bigrquery.r-dbi.org/reference/bq_param.md)
  or
...
- destination_table:
  ...
  A [bq_table](https://bigrquery.r-dbi.org/reference/bq_refs.md) where
  results should be stored. If not supplied, results will be saved to a
  temporary table that lives in a special dataset. You must supply this
  parameter for large queries (\> 128 MB compressed).

- default_dataset:

  A [bq_dataset](https://bigrquery.r-dbi.org/reference/bq_refs.md) used
  to automatically qualify table names.
...
A [bq_job](https://bigrquery.r-dbi.org/reference/bq_refs.md).
