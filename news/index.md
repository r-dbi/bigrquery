...
- [`bq_perform_query()`](https://bigrquery.r-dbi.org/reference/api-perform.md)
...
- [`bq_perform_upload()`](https://bigrquery.r-dbi.org/reference/api-perform.md)
...
- If [`bq_job_wait()`](https://bigrquery.r-dbi.org/reference/api-job.md)
...
- New
  [`bq_perform_query_dry_run()`](https://bigrquery.r-dbi.org/reference/api-perform.md)
...
- [`bq_perform_query()`](https://bigrquery.r-dbi.org/reference/api-perform.md)
  ...
  [`bq_param_array()`](https://bigrquery.r-dbi.org/reference/bq_param.md)
  to be explicit.
...
[`bq_user()`](https://bigrquery.r-dbi.org/reference/bq_user.md) is a new
function that reveals the email of the user associated with the current
token.
...
- [`bq_field()`](https://bigrquery.r-dbi.org/reference/bq_field.md) can
  now pass `description` parameter which will be applied in
...
- [`bq_job()`](https://bigrquery.r-dbi.org/reference/bq_refs.md) tracks
  location so bigrquery now works painlessly with non-US/EU locations
  ([\#274](https://github.com/r-dbi/bigrquery/issues/274)).
...
- [`dbi_driver()`](https://bigrquery.r-dbi.org/reference/bigquery.md) is
  deprecated; please use
  [`bigquery()`](https://bigrquery.r-dbi.org/reference/bigquery.md)
  instead.
...
- **S3 classes**:
  ...
  [`bq_field()`](https://bigrquery.r-dbi.org/reference/bq_field.md) and
...
- **Easier local testing**: New
  [`bq_test_project()`](https://bigrquery.r-dbi.org/reference/bq_test_project.md)
  and
  [`bq_test_dataset()`](https://bigrquery.r-dbi.org/reference/bq_test_project.md)
