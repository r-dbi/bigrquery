# Contributing to bigrquery

This outlines how to propose a change to bigrquery. For more detailed
...
See the internal help for
[`bq_test_project()`](https://bigrquery.r-dbi.org/reference/bq_test_project.html)
for information about setting up a test project and test bucket.

### Testing token

The overall approach to managing the service account token used in tests
is described in the gargle article [Managing tokens
...
Code of Conduct](https://bigrquery.r-dbi.org/dev/CODE_OF_CONDUCT.md). By
